# Generated by Django 3.0 on 2020-03-24 04:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marital', models.CharField(choices=[('married', '已婚'), ('unmarried', '未婚')], max_length=15, verbose_name='婚姻状况')),
                ('gender', models.BooleanField(choices=[('F', '女'), ('M', '男')], verbose_name='性别')),
                ...
                ('degree', models.CharField(choices=[('doctor', '博士'), ('master', '硕士研究生'), ('bachelor', '学士'), ('other', '其它')], max_length=50, verbose_name='学位')),
